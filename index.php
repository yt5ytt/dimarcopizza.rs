				...
				<div class="opis">
					...
					<!--<div class="text">
						<h2 style="color: greenyellow">
							Dragi naši,<br />
							U novoj 2018. godini želimo vam puno sreće i zdravlja.<br />
							Sve ono što poželite za sebe, neka vam od nas bude.<br />
					...
					<div class="center">Radno vreme:<br />ponedeljak - nedelja od 10h do 04:30h<br />
						<h2>Vaš Di Marco</h2>
					</div><!--kraj diva center-->
					
				</div><!--zavrsetak diva opis-->
			
			</div><!--zavrsetak diva snowing-->
